...
Physics encounters a conflict: to rotate \textbf{Mercury's} perihelion correctly, $K = 3.0$; to deflect \textbf{starlight}, $K = 1.5$. We bridge both states seamlessly by attributing the difference to the intrinsic speed of the body $v$:
\begin{equation}
...
Satellite motion induces localized kinematic drag, dropping ticks:
\begin{equation}
...
\textbf{The Simulation Verdict:} Net clock advance of $\mathbf{38.6\ \mu s}$/day.
