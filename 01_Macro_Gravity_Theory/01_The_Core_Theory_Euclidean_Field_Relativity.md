...
## 1. The Kinematic Mechanism: Variable Medium Impedance
...
### 1.1 The Density Gradient of the Field Medium
...
### 1.2 Resolving the Mercury Anomaly
...
### 1.3 Optical Equivalence (Refraction)
...
Our initial computational attempts sought to upgrade Newtonian physics into relativity by applying a basic energetic-momentum multiplier rooted in the total systemic velocity, $a_{new} = a_{Newton}(1 + v^2/c^2)$. 
...
## 4. Gravitational Redshift: Universal vs. Quantum Components
