...
|---|------|-------------|------------|--------|--------|
| 001 | Molaro q-test | Solar (Molaro 2012) | 31 lines | r=-0.27 | Inconclusive (Noise) |
...
2. **The "Smoking Gun" (005 & 006):** In extreme gravity wells (White Dwarfs), 
   the alpha signal scales up dramatically. High-precision archival data from 
   Keck (HIRES) and VLT (ESPRESSO) confirm a persistent **~2 km/s differential shift** 
   between elements (Mg vs Si). 
