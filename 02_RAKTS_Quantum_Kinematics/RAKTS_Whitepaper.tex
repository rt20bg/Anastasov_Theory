...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item $d_{ij} = |\vec{v}_i - \vec{v}_j|$ is the physical spatial distance between the fluid streams.
...
\begin{enumerate}
    \item \textbf{Radial Pressure Balance:} In RAKTS, atoms do not collapse into the nucleus or fly apart because of a mechanical balance of pressures in the Field Medium. The rapidly spinning nucleus creates a massive internal centrifugal boundary shield ($+B/r^4$) that pushes fluid outward, while simultaneously generating a deep vacuum deficit ($-A/r$) that pulls fluid inward. 
